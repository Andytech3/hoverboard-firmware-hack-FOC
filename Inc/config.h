...
#define DIAG_ENA        0               // [-] Diagnostika motorov pri zapnutí : 0 = Disabled, 1 = Enabled (default) 
...
#define INACTIVITY_TIMEOUT        8       // Minuty pre auto off pri necinosti
#define BEEPS_BACKWARD            1       // 0 or 1 Pípanie pri cúvaní
...
// ############################## CRUISE CONTROL SETTINGS ##########TEMPOMAT##########
/* Cruise Control info:
...
// #define DEBUG_SERIAL_USART2          // left sensor board cable, disable if ADC or PPM is used!
 //#define DEBUG_SERIAL_USART3          // right sensor board cable, disable if I2C (nunchuk or lcd) is used! !!!!!!!!!!!!!!!!ASI ODKOMENTOVAŤ !!!!!!!!!!!!!!!
...
// ############################ VARIANT_HOVERCAR SETTINGS ############################
  ...
  #define CONTROL_ADC             0         // use ADC as input. Number indicates priority for dual-input. Disable CONTROL_SERIAL_USART2, FEEDBACK_SERIAL_USART2, DEBUG_SERIAL_USART2!
  #define CONTROL_SERIAL_USART3 1         // Rx from right sensor board: to use photosensors as buttons. Number indicates priority for dual-input. Comment-out if sideboard is not used!
  ...
  #define PRI_INPUT1              1,   200, 0, 4000, 0  // Pedal Brake        TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #define PRI_INPUT2              1,   200, 0, 4000, 0  // Pedal Accel        TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
